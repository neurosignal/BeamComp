...
noise_cov = mne.compute_covariance(epochs, tmin=-0.200, tmax=-0.020, method='empirical') 
data_cov  = mne.compute_covariance(epochs, tmin=0.020, tmax=0.200,   method='empirical')   
