...
mrifname    = [mri_dir 'nenonen_jukka-amit-170204-singlecomplete.fif'];
segmrifname = [mri_dir 'nenonen_jukka_1_01-brain.mat'];
filename    = 'Simulated_evoked_200nAm_at_-0.1_94.9_50.4mm-ave_OVER_spont_eo_raw_sss.fif';
...
if ~isequal(fname(end-6:end-4), 'sss')
