...
%% Add SPM12 in path % uncoment it
clear all; clc  % uncoment it
restoredefaultpath % uncoment it
restoredefaultpath % uncoment it
...
data_dir = '/net/qnap/data/rd/ChildBrain/BeamComp_DataRepo/MEG/Simulated/';
...
filename        = 'Simulated_evoked_30nAm_at_-8.4_51.2_22.7mm-ave_OVER_spont_eo_raw.fif';
...
if isequal(fname(end-6:end-4), 'raw')
...
diary([code_dir 'diary_SPM_Simulated_results.txt'])
